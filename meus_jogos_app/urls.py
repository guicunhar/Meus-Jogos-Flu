...
from meus_jogos_app.views import lista_jogos, lista_outros_jogos,estatisticas_jogadores, estatisticas_gerais,estatisticas_adv,estatisticas_datas,personalizar
